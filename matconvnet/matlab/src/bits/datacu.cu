...
vl::CudaHelper::resetCudnnConvolutionSettings()
{
  ...
  cudnnConvolutionFwdWorkSpaceLimit = 1024 * 1024 * 1024 ; // 512MB -> 4GB
  ...
  cudnnConvolutionBwdFilterWorkSpaceLimit = 1024 * 1024 * 1024 ; // 512MB -> 4GB
  ...
  cudnnConvolutionBwdDataWorkSpaceLimit = 1024 * 1024 * 1024 ; // 512MB -> 4GB
