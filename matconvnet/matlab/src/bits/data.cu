...
vl::TensorShape::TensorShape(size_t height, size_t width, size_t anheight, size_t anwidth, size_t depth, size_t size)
: numDimensions(6)
{
  dimensions[0] = height ;
  dimensions[1] = width ;
  dimensions[2] = anheight ;
  dimensions[3] = anwidth ;
  dimensions[4] = depth ;
  dimensions[5] = size ;
}
